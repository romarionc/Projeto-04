const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/script2.js","js/script.js","css/styles.css","js/cadastro-validation.js"])))=>i.map(i=>d[i]);
import{_ as n}from"./script.js";function d(e){return e.map(a=>`
